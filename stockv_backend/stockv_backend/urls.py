...
urlpatterns = [
    ...
    path('verify-password/', PasswordVerificationView.as_view(),
    ...
    path('remove-saved-coin/', RemoveSavedCoinView.as_view(),
         name='remove-saved-coin'),
    ...
    path('get-transaction-history/<str:pk>/',
         GetTransactionHistoryView.as_view(), name='get-transaction-history'),
    path('get-user-balance/<str:pk>/',
         GetUserBalanceView.as_view(), name='get-user-balance'),
    path('get-chart-patterns/', GenerateChartPatterns.as_view(),
